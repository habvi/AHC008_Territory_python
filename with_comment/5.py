...
# make pair
# 中央に200の人がいたら左か右のまだペアがいない方(少ない方)の近い人とペアにして
# 2人の中央あたりに合流ポイントを決めてそこまで200しながら進む
def can_make_pair_left(g, hi):
    return '.'
...
# 
def can_make_pair_right(g, hi):
    return '.'

# 左も右もペアができてたらstate_210にする
...
# pair move
# 内側だけ見るpair
def do_state_150(g, hi):
    return '.'


# 内側と端を交互に見るpair
def do_state_170(g, hi):
    return '.'
...
def do_each_roles(g):
    ...
    # 左と中央,中央と右に200がいるかcheck,新規pairを作れたら作ってpair_listへ追加

    # pairを動きを決める

    # pairの人のnext_moveをまとめて更新
